...
for i in ProduceDictionary:
    produceName = i
    calculatedTotal = round(ProduceDictionary[i]['cost'] *
                            ProduceDictionary[i]['amt_sold'], 2)
    statedTotal = round(ProduceDictionary[i]['total'], 2)

    if calculatedTotal != statedTotal:
        print(f"Produce Name: {i}")
        print(f"Calculated Total: ${calculatedTotal:,.2f}")
        print(f"Stated Total: ${statedTotal:,.2f}")
        print()
